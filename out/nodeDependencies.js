...
const addPanel_1 = require("./databaseInfo/addPanel");
class DepNodeProvider {
    constructor(workspaceRoot = undefined) {
        this.workspaceRoot = workspaceRoot;
    }
    addPanel(extensionUri) {
        addPanel_1.AddPanel.createOrShow(extensionUri);
    }
    refresh() { }
    getTreeItem(element) {
        return element;
    ...
    getDepsInPackageJson(packageJsonPath) {
        if (this.pathExists(packageJsonPath)) {
            ...
            const toDep = (moduleName, version) => {
                var _a;
                if (this.pathExists(path.join((_a = this.workspaceRoot) !== null && _a !== void 0 ? _a : '', 'node_modules', moduleName))) {
