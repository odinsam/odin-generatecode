...
class AddPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(AddPanel.viewType, 'Connection Database', column || vscode.ViewColumn.One, getWebviewOptions(extensionUri));
    ...
    _getHtmlForWebview(webview) {
        ...
        const scriptPathOnDisk = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'media', 'main.js'));
